...
let yupiSate = new List_items("PERMEN","YUPI-SATE",1);

//LIST ITEMS PERMEN
let listPermen = [
  mint,bigBabol,golia,dinosX,relax,lazery,piramid,kopiko,yupi,hotPermen,kissMint,yupiSate
  ];
