...
let juaraKrtk = new List_items("ROKOK","JUARA-TEH",1);
...
// LIST OBJECK OBAT
let vegeta = new List_items("OBAT","VEGETA",1);
...
let wafelloCaramel = new List_items("KUE-ROTI","WAFELLO-CARAMEL-1000",1);
...
let indoAceh = new List_items("MIE","INDO-ACEH",1);
...
let garamDap = new List_items("DAPUR","GARAM-DAPUR",1);
let buryam1000 = new List_items("DAPUR","BURYAM-1000",7);
let kertasNasi = new List_items("DAPUR","KERTAS-NASI",1);
let teriguPerapat = new List_items("DAPUR","TERIGU-PERAPAT",1);
// LIST ITEMS DAPUR
let listDapur = [
