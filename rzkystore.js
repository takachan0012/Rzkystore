...
let oskadonSP = new List_items("OBAT","OSKADON-SP",1);
...
let reumacyl = new List_items("OBAT","NEO-REUMACYL",1);
...
let balsemLang = new List_items("OBAT","BALSEM-LANG",1);
...
let moltoBiru = new List_items("KAMAR-MANDI","MOLTO-BIRU",1);
...
let rinsoLiq = new List_items("KAMAR-MANDI","RINSO-CAIR",1);
...
let roycoAy = new List_items("DAPUR","ROYCO-AYAM-SACHET",1);
let terasiAbc = new List_items("DAPUR","TERASI-ABC-SACHET",7);
let terasiUleg = new List_items("DAPUR","SAMBAL-ULEG",7);
...
// LIST ITEMS TAMBAHAN
let listTambahan = [
  kiwi,swallow15K,lamp15,lamp10,remi,kresekBolaKcl,plastikRokok,gapleh,powerGlue,plastikEs2000,abon,lamp20,korekKuping,bateraiJam,bateraiRemot,kresekBolaBesar
 ]
