...
let magnumBlk12 = new List_items("ROKOK","MAGNUM-BLACK12-BINTANG",1);
...
let ceteme = new List_items("OBAT","CETEME",1);
...
// LIST ITEMS OF SNACK
let listSnack = [twist2000,chitatoLite,chitatoBbq,kuaciRebo,ajisuka,pangpang,astaga,pilusBbq,kcgKulit,rostaIjo,moringPds,kerupuk2000,kerupukBantet,dadaliCkr,basreng1000,rostaMerah,gAtom,sosisAyam,pilusOri,pilusPds,kcgPolong,dadaliCjr,koroMerah,moringAsin,koroIjo,taroBbq,sosisSapi,qtelaBbq,frenchFri,makaroni1000,potato2000,gAtom2000,mondeSnack5000
];
...
let pastaKeju500 = new List_items("KUE-ROTI","PASTA-KEJU-500",1);
let pastaCkt500 = new List_items("KUE-ROTI","PASTA-COKLAT-500",1);
...
let gCoolin = new List_items("PERKOPIAN","GOODDAY-COOLIN",1);
...
let susuCkt = new List_items("PERKOPIAN","SUSU-COKLAT-SACHET",1);
...
let rinso1000 = new List_items("KAMAR-MANDI","RINSO-1000-BUBUK",7);
...
let jazOne = new List_items("KAMAR-MANDI","JAZ-1",7);
...
let uCkt125 = new List_items("MINUMAN","ULTRA-CKT-125",1);
...
let indoRend = new List_items("MIE","INDO-RENDANG",1);
...
let bubur3000 = new List_items("DAPUR","SUPER-BUBUR-3,5K",1);
...
let racikNasGor = new List_items("DAPUR","RACIK-NASI-GORENG",1);
// LIST ITEMS DAPUR
let listDapur = [
...
let laurierPink = new List_items("BABY","LAURIER-PINK",1);
