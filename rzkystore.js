...
let super12 = new List_items("ROKOK","SUPER12",1);
...
let surya12 = new List_items("ROKOK","SURYA12",7);
...
let magnumBlk12 = new List_items("ROKOK","MAGNUM-BLACK12-ORI-DAN-BINTANG",1);
...
let mbKretekBiru = new List_items("ROKOK","MB-BIRU-KRETEK",1);
let mbIceburst = new List_items("ROKOK","MB-ICE-BURST",7);
let mbMerah = new List_items("ROKOK","MB-MERAH",7);
let mbPutih = new List_items("ROKOK","MB-PUTIH",7);
let sm12 = new List_items("ROKOK","SM12",1);
let sm16 = new List_items("ROKOK","SM16",1);
let smKrtk = new List_items("ROKOK","SM-KRETEK",1);
...
let esJuicy20 = new List_items("ROKOK","ESSE-JUICY-20",7);
let camel = new List_items("ROKOK","CAMEL12",1);
let camel16 = new List_items("ROKOK","CAMEL16",1);
let jazyBold = new List_items("ROKOK","JAZY-BOLD",1);
let juaraKrtk = new List_items("ROKOK","JUARA-TEH",7);
let mustika = new List_items("ROKOK","MUSTIKA-KRETEK",7);
let magnumMax = new List_items("ROKOK","MAGNUM-MAX20",7);
let onJasmin = new List_items("ROKOK","ON-JASMINE-KRETEK",7);
let bintangMas = new List_items("ROKOK","BINTANG-MAS-KRETEK",7);
let djavaHijau = new List_items("ROKOK","DJAVA-IJO-KRETEK",7);
let bhumi = new List_items("ROKOK","BHUMI-KRETEK",7);
let esBerypop12 = new List_items("ROKOK","ESSESSE-BERRYPOP-12",1);
...
let langsep = new List_items("ROKOK","LANGSEP",7);
let twizz = new List_items("ROKOK","TWIZZ",7);
let juaraJambu = new List_items("ROKOK","JUARA-JAMBU",7);
let janaka = new List_items("ROKOK","JANAKA",7);
let onlineGrape = new List_items("ROKOK","ONLINE-GRAPE",7);
let jazyKretek = new List_items("ROKOK","JAZY-KRETEK",7);

// List Items ROKOK
let listRokok = [laBold,mldBlack16,djarcok,super12,super50,signatureBlk,ggMerah,proMerah,proPutih,surya12,surya16,ggFilter12,ggFilter50,samsuKretek,magnumBlk12,samsuPrem,mbFb12,mbFb20,mbKretekBiru,mbIceburst,mbMerah,mbPutih,sm12,sm16,smKrtk,smMenthol16,esBerypop12,esBerypop16,esApplemint,esJuicy20,camel,jazyBold,juaraKrtk,mustika,magnumMax,onJasmin,bintangMas,djavaHijau,bhumi,cakra,laIcePurple,kingSuper,langsep,twizz, camel16,juaraJambu,janaka,onlineGrape,jazyKretek
];

// LIST OBJECK OBAT
let vegeta = new List_items("OBAT","VEGETA",7);
let konidin = new List_items("OBAT","KONIDIN",7);
let neozep = new List_items("OBAT","NEOZEP",7);
...
let bintang7 = new List_items("OBAT","BINTANG-7",1);
let entroStopAnak = new List_items("OBAT","ENTROSTOP-ANAK",7);
let komikObh = new List_items("OBAT","KOMIK-CAMPUR",7);
...
let bodrexi = new List_items("OBAT","BODREXIN",1);
...
let panadolBiru = new List_items("OBAT","PANADOL-BIRU",7);
...
let tolakLinu = new List_items("OBAT","TOLAK-LINU",7);
let hitElectric = new List_items("OBAT","HIT-ELECTRIC",7);
let hotInCream = new List_items("OBAT","HOT-IN-CREAM",1);
// LIST ITEMS OBAT
let listObat = [vegeta,konidin,neozep,panadoL_ijo,viks_inhelar,bejo_jahe,antangin,waisan,tAnginDws,contrexin,byeFever,promag,kayuPutihKcl,sgrDinginOri,ceteme,vitacimin,bodrex_FB,baygonBkr,koyoCabe,salonpas,bintang7,entroStopAnak,komikObh,oskadonSP,oskadonBiru,mixagripFlu,mixagripFB,geliga,freshCareMerah,hitBakar1000,betadin,laserin,reumacyl,paramexKepala,ademsariSet,aladina,madurasa,antimo,tAnginAnak,hansaplas,insto_mata,bodrexi,gpu,poldanMig,balsemLang,bodreX,paracetamol,ultraFlu,bedakMBK,bodrexEx,diapet,panadolBiru,panadolExtra,panadolAnak,napacine,tolakLinu,hitElectric,hotInCream
];
...
let mirandColor = new List_items("STYLELIST","MIRANDA-WARNA",7);
...
let rexonaWomen = new List_items("STYLELIST","REXONA-WANITA",7);
let marinaHandbody = new List_items("STYLELIST","MARINA-HANDBODY-KECIL",7);
// LIST ITEMS KECANTIKAN
let listStylist = [mirandBlack,tisu2500,mirandBlech,mirandColor,tisuBesar,kapasSelection,rexonaMen,rexonaWomen,marinaHandbody];
...
let gunting = new List_items("ALAT-TULIS-KANTOR","GUNTING-KECIL",7);
let guntingBenang = new List_items("ALAT-TULIS-KANTOR","GUNTING-BENANG",7);
let lemKertas = new List_items("ALAT-TULIS-KANTOR","LEM-KERTAS",7);

// LIST ITEMS WRITER TOOLS AND OFFICE
let listATK = [lakbanPthkcl,lakbanPthbsr,etona,bonRangkap,spidolPermanent,pulpen,buku,penghapus,gunting,guntingBenang,lemKertas];

// LIST OBJECK SNACK 
let twist2000 = new List_items("SNACK","TWIST-2000",1);
...
let rostaIjo = new List_items("SNACK","ROSTA-IJO",1);
...
let dadaliCkr = new List_items("SANCK","DADALI-CIKUR",1);
let basreng1000 = new List_items("SNACK","BASRENG-1000-PEDAS",1);
let rostaMerah = new List_items("SNACK","ROSTA-MERAH",1);
let gAtom = new List_items("SNACK","GARUDA-ATOM",7);
let gAtom2000 = new List_items("SNACK","GARUDA-ATOM-2000",7);
let sosisAyam = new List_items("SNACK","SOSIS-AYAM",7);
let pilusRumputLaut = new List_items("SNACK","PILUS-RUMPUT-LAUT",1);
...
let frenchFri = new List_items("SNACK","FRENCH-FRIES2000",7);
let makaroni1000 = new List_items("SNACK","MAKARONI-1000",7);
let potato2000 = new List_items("SNACK","POTATO-2000",1);
let mondeSnack5000 = new List_items("SNACK","MONDE-SNACK-5000",1);
let kerupukKulit = new List_items("SNACK","KERUPUK-KULIT-2000",1);
// LIST ITEMS OF SNACK
let listSnack = [twist2000,chitatoLite,chitatoBbq,kuaciRebo,ajisuka,pangpang,astaga,pilusBbq,kcgKulit,rostaIjo,moringPds,kerupuk2000,kerupukBantet,dadaliCkr,basreng1000,rostaMerah,gAtom,sosisAyam,pilusRumputLaut,pilusPds,kcgPolong,dadaliCjr,koroMerah,moringAsin,koroIjo,taroBbq,sosisSapi,qtelaBbq,frenchFri,makaroni1000,potato2000,gAtom2000,mondeSnack5000
];
...
let malkistCrackers7k = new List_items("KUE-ROTI","MALKIST-CRACKERS-7K",1);
let chocoKeju1000 = new List_items("KUE-ROTI","CHOCOLATOS-KEJU-1000",1);
...
let malkistCkt7k = new List_items("KUE-ROTI","MALKIST-COKLAT-7K",1);
...
let malkistCrk1000 = new List_items("KUE-ROTI","MALKIST-CRACKERS-1000",1);
...
let bonitaBolu = new List_items("KUE-ROTI","BONITA-BOLU",1);
let wafello2000 = new List_items("KUE-ROTI","WAFELLO-2000",7);
let wallens = new List_items("KUE-ROTI","WALLENS-2000",7);

// LIST ITEMS KUE-ROTI
let listKueRoti = [
  sariGandumSandwice,roti2000,rotiAoka,marieTunggal,pastaKeju500,pastaCkt500,ardenKue,malkistCrackers7k,chocoKeju1000,time2000,slaiOlai2000,vegeChs,regalDuoCkt,regalDuoKcg,gery2000,malkistCkt7k,betterKue,wafelloCkt,wafelloCaramel,chocoCkt1000,nextar2000,superstar1000,malkistAbon1000,cokiCoki,kalpa2000,gorio500,nabati2000,malkistCkt1000,chocopie,bengWfer,gerycrackerKeju,oreoBolu,chocolatos500,nabatiRolls,oreoSandwice,bigrolKeju,malkistCrk1000,bigrolCkt,ahh1000,time1000,regal1000,romaKelapa,romaSandwice,astor1000,bonitaBolu,wafello2000,wallens
  ];

// LIST OBJECT KOPI
let marimasSet = new List_items("PERKOPIAN","MARIMAS-SIRSAK-JERUK",1);
...
let sariwangiSet = new List_items("PERKOPIAN","SARIWANGI-SACHET",1);
...
let esteEmje = new List_items("PERKOPIAN","ESTE-EMJE",1);
...
let gCarabian = new List_items("PERKOPIAN","GOODDAY-CARABIAN",1);
...
let amhMerah = new List_items("PERKOPIAN","AMH-JAHE-MERAH",7);
let eKurma = new List_items("PERKOPIAN","ENERGEN-KURMA",7);
let susuKaleng = new List_items("PERKOPIAN","SUSU-KALENG-PTH",7);
let milo2000 = new List_items("PERKOPIAN","MILO-2000-SACHET",7);
let kukubima = new List_items("PERKOPIAN","KUKUBIMA-ANGGUR",7);
// LIST ITEMS KOPI
let listKopi = [
  marimasSet,energenIjo,energenVanila,eKurma,maxteaSet,gCappucino,nutrisariJP,sariwangiSet,dancowPutih,creamyLate,kapalMix,topAren,dancowCkt,berasMerah,esteEmje,gCoolin,gVanilla,abcSusu,toraDuo,abcPlus,luwakWhite,gilusMix,susuPutih,gCarabian,angetSuje,susuCkt,gMerah,energenCkt,gCkt,indoCafe,extraJoss,amhMerah,susuKaleng,milo2000,kukubima
  ]

// LIST OBJECT KAMAR MANDI
let ciptPasta = new List_items("KAMAR-MANDI","CIPTADENT-PASTA",1);
...
let rinso1000 = new List_items("KAMAR-MANDI","RINSO-1000-BUBUK",1);
...
let indoPth125 = new List_items("MINUMAN","INDOMILK-PTH-125",1);
...
let krating = new List_items("MINUMAN","KRATINGDENG",1);
...
let tehKotak = new List_items("MINUMAN","TEH-KOTAK",1);
...
let c1000_ORG = new List_items("MINUMAN","C1000-ORANGE/LEMON",7);
let tehPucuk = new List_items("MINUMAN","TEH-PUCUK",7);
let buaVit = new List_items("MINUMAN","BUAVITA",1);
...
let nipisMadu = new List_items("MINUMAN","NIPIS-MADU",1);
let leMineral600 = new List_items("MINUMAN","LE-MINERAL-600",7);
let chimory10k = new List_items("MINUMAN","CHIMORY-10K",1);
let leMineral1L = new List_items("MINUMAN","LE-MINERAL-1L",1);
// LIST ITEMS BEVERAGE
let listBeverage = [
  kopkap2000,amoCola,amoStr,amoLemon,isoPlus,bearBrand,uCkt250,indoPth125,hydCoco,zoda,milkuCkt,milkuStr,bintangZero,cingkuKal,krating,tehRio,coLa,uStr250,uPth250,panta,goldaCofe,gCktBotol,pocariS,tebsKaleng,minral_1L,kaki3Kaleng,tehKotak,isoCup,ale,uCkt200,nutriBost,FloriJeruk,uStr125,c1000_ORG,tehPucuk,buaVit,sariKcg,kaki3BtlBesar,sprit,aqua_1L,panther,okBig,mizon,aqua_Gelas,yogurtDrink,powerF,aqua_600,tehGelasBig,uCkt125,esTeler,cincauPand,monti1000,kaki3BtlKcl,tehGelas1000,minral600,nipisMadu,leMineral600,chimory10k,leMineral1L
  ]
...
let indoRica = new List_items("MIE","INDO-RICA",1);
...
let indoGeprek = new List_items("MIE","INDO-GEPREK",1);
...
let indoGeti = new List_items("MIE","INDO-GETI",1);
...
let minyakSet = new List_items("DAPUR","MINYAK-SACHET",7);
let nutriJel = new List_items("DAPUR","NUTRIJEL-AGAR",1);
let sardenKal = new List_items("DAPUR","SARDEN",7);
...
let kertasNasi = new List_items("DAPUR","KERTAS-NASI",7);
let teriguPerapat = new List_items("DAPUR","TERIGU-PERAPAT",7);
let aciPerapat = new List_items("DAPUR","ACI-PERAPAT",1);
let racikNasGor = new List_items("DAPUR","RACIK-NASI-GORENG",7);
// LIST ITEMS DAPUR
let listDapur = [
  minyakPer,telur,beras,kecapBango,abcExtra,roycoAy,terasiAbc,terasiUleg,miki,minyak1L,gulaPthPer,mentegaSet,gulaPthSet,sasa500,korekKayu,roycoSapi,bonCabe,korekTokai,minyakSet,nutriJel,sardenKal,sasa5000,sasa3000,bubur3000,garamDap,buryam1000,kertasNasi,teriguPerapat,aciPerapat,racikNasGor
  ]
...
let yupiMarsmellow = new List_items("PERMEN","YUPI-MARSMELLOW",7);
...
let mentos = new List_items("PERMEN","MENTOS",7);

let hexos = new List_items("PERMEN","HEXOS",7);
//LIST ITEMS PERMEN
let listPermen = [
  mint,bigBabol,golia,dinosX,relax,lazery,piramid,kopiko,yupi,hotPermen,kissMint,yupiSate,fruit,mentos,yupiMarsmellow,hexos
  ];
...
let bateraiRemot = new List_items("TAMBAHAN","BATERAI-REMOTE",7);
...
let kado = new List_items("TAMBAHAN","KERTAS-KADO",7);
let masker2000 = new List_items("TAMBAHAN","MASKER-HITAM/PUTIH-2K",7);
let siletGoal = new List_items("TAMBAHAN","SILET-GOAL",7);
let siletTiger = new List_items("TAMBAHAN","SILET-TIGER",7);
let autan = new List_items("TAMBAHAN","AUTAN",7);
let soffel = new List_items("TAMBAHAN","SOFFEL",1);
// LIST OBJECT BABY
...
let laurierPink = new List_items("BABY","LAURIER-PINK",7);

//LIST ITEMS BABY
let listBaby = [
  mamyXl,mamyL,mamyS,mamyM,charm2,charmOrg,laurierPink
  ];
...
// LIST ITEMS TAMBAHAN
let listTambahan = [
  kiwi,swallow15K,lamp15,lamp10,remi,kresekBolaKcl,plastikRokok,gapleh,powerGlue,plastikEs2000,abon,lamp20,korekKuping,bateraiJam,bateraiRemot,kresekBolaBesar,cupCoffee,lamp5, lilin,kado,masker2000,siletGoal,siletTiger,autan,soffel
 ]
