...
let rexonaMen = new List_items("STYLELIST","REXONA-MEN",7);
...
let dancowCkt = new List_items("PERKOPIAN","DANCOW-COKLAT",1);
...
let nutriBost = new List_items("MINUMAN","NUTRIBOOST",1);
let FloriJeruk = new List_items("MINUMAN","FLORIDINA-JERUK",7);
let uStr125 = new List_items("MINUMAN","ULTRA-STR-125",1);
