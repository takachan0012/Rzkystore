...
let ultraFlu = new List_items("OBAT","ULTRA-FLU",1);
let bedakMBK = new List_items("OBAT","BEDAK-MBK",1);
// LIST ITEMS OBAT
let listObat = [vegeta,konidin,neozep,panadoL_ijo,viks_inhelar,bejo_jahe,antangin,waisan,tAnginDws,contrexin,byeFever,promag,kayuPutihKcl,sgrDinginOri,ceteme,vitacimin,bodrex_FB,baygonBkr,koyoCabe,salonpas,bintang7,entroStopAnak,komikObh,oskadonSP,oskadonBiru,mixagripFlu,mixagripFB,geliga,freshCareMerah,hitBakar1000,betadin,laserin,reumacyl,paramexKepala,ademsariSet,aladina,madurasa,antimo,tAnginAnak,hansaplas,insto_mata,bodrexi,gpu,poldanMig,balsemLang,bodreX,paracetamol,ultraFlu,bedakMBK
];
...
let listStylist = [mirandBlack,tisu2500,mirandBlech,mirandColor,tisuBesar,kapasSelection];
...
let sariGandumSandwice = new List_items("KUE-ROTI","SARI-GANDUM-SANDWICE",1);
...
let ardenKue = new List_items("KUE-ROTI","ARDEN-2000",1);
...
let oreoBolu = new List_items("KUE-ROTI","OREO-BOLU",1);
...
let abcPlus = new List_items("PERKOPIAN","ABC-PLUS",1);
...
let sunlight5000 = new List_items("KAMAR-MANDI","SUNLIGHT-5000",1);
...
let sabunCair = new List_items("KAMAR-MANDI","SABUN-CAIR",1);
// LIST ITEMS KAMAR-MANDI
let listKamarMandi = [
  ciptPasta,peptPasta,shampoLF,shampoClrBiru,panteneCond,mamaLemon,shampoHS,moltoBiru,sabunGive,sabunLFbiru,dettolOrg,liquidPink,sunlight5000,panteneBiru,sunlight2000,rejoice,sabunColek2000,downyHitam,procline500,fnl_wash,rinso1000,shinzui,sikatFormula,zincShamp,rinsoLiq,clearMan,wipol,sabunCair
  ]
...
let bearBrand = new List_items("MINUMAN","BEAR-BRAND",1);
...
let okBig = new List_items("MINUMAN","OKKY-BIG",1);
...
// LIST OBJECT DAPUR
let minyakPer = new List_items("DAPUR","MINYAK-PERAPAT",1);
...
let buryam1000 = new List_items("DAPUR","BURYAM-1000",1);
// LIST ITEMS DAPUR
let listDapur = [
...
let dinosX = new List_items("PERMEN","DINOS-X",1);
let relax = new List_items("PERMEN","RELAXA",7);
let lazery = new List_items("PERMEN","LAZERY",1);
let piramid = new List_items("PERMEN","PIRAMID-CKT",1);
...
let lilin = new List_items("TAMBAHAN","LILIN",1);
// LIST OBJECT BABY
...
// LIST ITEMS TAMBAHAN
let listTambahan = [
  kiwi,swallow15K,lamp15,lamp10,remi,kresekBolaKcl,plastikRokok,gapleh,powerGlue,plastikEs2000,abon,lamp20,korekKuping,bateraiJam,bateraiRemot,kresekBolaBesar,cupCoffee,lamp5, lilin
 ]
