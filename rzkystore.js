...
let ggFilter12 = new List_items("ROKOK","GARPIT12",7);
let ggFilter50 = new List_items("ROKOK","GARPIT50",7);
let samsuKretek = new List_items("ROKOK","SAMSU-KRETEK",1);
let magnumBlk12 = new List_items("ROKOK","MAGNUM-BLACK12-BINTANG",1);
let samsuPrem = new List_items("ROKOK","SAMSU-PREM",1);
...
let esJuicy20 = new List_items("ROKOK","ESSE-JUICY-20",1);
...
let juaraJambu = new List_items("ROKOK","JUARA-JAMBU",1);
let janaka = new List_items("ROKOK","JANAKA",1);
...
let konidin = new List_items("OBAT","KONIDIN",1);
let neozep = new List_items("OBAT","NEOZEP",1);
...
let basreng1000 = new List_items("SNACK","BASRENG-1000-PEDAS",7);
let rostaMerah = new List_items("SNACK","ROSTA-MERAH",1);
let gAtom = new List_items("SNACK","GARUDA-ATOM",1);
let gAtom2000 = new List_items("SNACK","GARUDA-ATOM-2000",7);
let sosisAyam = new List_items("SNACK","SOSIS-AYAM",1);
...
let sosisSapi = new List_items("SNACK","SOSIS-SAPI",1);
...
let mondeSnack5000 = new List_items("SNACK","MONDE-SNACK-5000",7);
...
let superstar1000 = new List_items("KUE-ROTI","SUPER-STAR-1000",1);
let malkistAbon1000 = new List_items("KUE-ROTI","MALKIST-ABON-1000",1);
...
let romaKelapa = new List_items("KUE-ROTI","ROMA-KELAPA",1);
...
let gMerah = new List_items("PERKOPIAN","GOODDAY-MERAH",1);
...
let sikatFormula = new List_items("KAMAR-MANDI","SIKAT-GIGI-FORMULA",1);
...
let soklinLantai = new List_items("KAMAR-MANDI","SOKLIN-LANTAI",1);
...
let sprit = new List_items("MINUMAN","SPRITE",1);
...
let tehGelasBig = new List_items("MINUMAN","TEH-GELAS-BIG",1);
...
let indoGor = new List_items("MIE","INDO-GORENG",1);
...
let indoSeblak = new List_items("MIE","INDO-SEBLAK",1);
...
// LIST ITEMS DAPUR
let listDapur = [
  minyakPer,telur,beras,kecapBango,abcExtra,roycoAy,terasiAbc,terasiUleg,miki,minyak1L,gulaPthPer,mentegaSet,gulaPthSet,sasa500,korekKayu,roycoSapi,bonCabe,korekTokai,minyakSet,nutriJel,sardenKal,sasa5000,sasa3000,bubur3000,garamDap,buryam1000,kertasNasi,teriguPerapat,aciPerapat
  ]
...
let yupi = new List_items("PERMEN","YUPI-500",1);
...
let autan = new List_items("TAMBAHAN","AUTAN",1);
