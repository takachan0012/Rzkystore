...
let camel = new List_items("ROKOK","CAMEL",1);
...
let poldanMig = new List_items("OBAT","POLDAN-MIG",1);
let balsemLang = new List_items("OBAT","BALSEM-LANG",7);
let bodreX = new List_items("OBAT","BODREX",7);
let paracetamol = new List_items("OBAT","PARACETAMOL-DWS",1);
// LIST ITEMS OBAT
let listObat = [vegeta,konidin,neozep,panadoL_ijo,viks_inhelar,bejo_jahe,antangin,waisan,tAnginDws,contrexin,byeFever,promag,kayuPutihKcl,sgrDinginOri,ceteme,vitacimin,bodrex_FB,baygonBkr,koyoCabe,salonpas,bintang7,entroStopAnak,komikObh,oskadonSP,oskadonBiru,mixagripFlu,mixagripFB,geliga,freshCareMerah,hitBakar1000,betadin,laserin,reumacyl,paramexKepala,ademsariSet,aladina,madurasa,antimo,tAnginAnak,hansaplas,insto_mata,bodrexi,gpu,poldanMig,balsemLang,bodreX,paracetamol
];
...
let tisuBesar = new List_items("STYLELIST","TISU-BESAR",1);
// LIST ITEMS KECANTIKAN
let listStylist = [mirandBlack,tisu2500,mirandBlech,mirandColor,tisuBesar];
...
let pulpen = new List_items("ALAT-TULIS-KANTOR","PULPEN-STANDART-HITAM",1);
...
// LIST ITEMS OF SNACK
let listSnack = [twist2000,chitatoLite,chitatoBbq,kuaciRebo,ajisuka,pangpang,astaga,pilusBbq,kcgKulit,rostaIjo,moringPds,kerupuk2000,kerupukBantet,dadaliCkr,basreng1000,rostaMerah,gAtom,sosisAyam,pilusOri,pilusPds,kcgPolong,dadaliCjr,koroMerah,moringAsin,koroIjo,taroBbq,sosisSapi,qtelaBbq,frenchFri,makaroni1000
];
...
let wafelloCkt = new List_items("KUE-ROTI","WAFELLO-COKLAT-1000",1);
let wafelloCaramel = new List_items("KUE-ROTI","WAFELLO-CARAMEL-1000",1);
let chocoCkt1000 = new List_items("KUE-ROTI","CHOCOLATOS-COKLAT-1000",1);
...
let malkistCkt1000 = new List_items("KUE-ROTI","MALKIST-COKLAT-1000",1);
...
let nabatiRolls = new List_items("KUE-ROTI","NABATI-ROLLS",1);
let oreoSandwice = new List_items("KUE-ROTI","OREO-SANDWICE",7);
let bigrolKeju = new List_items("KUE-ROTI","BIGROLL-KEJU",1);
...
let romaSandwice = new List_items("KUE-ROTI","ROMA-SANDWICE-2000",1);
// LIST ITEMS KUE-ROTI
let listKueRoti = [
...
// LIST OBJECT KOPI
let marimasSet = new List_items("PERKOPIAN","MARIMAS",1);
...
let sabunGive = new List_items("KAMAR-MANDI","SABUN-GIVE",1);
let sabunLFbiru = new List_items("KAMAR-MANDI","SABUN-LF-BIRU",1);
...
let rejoice = new List_items("KAMAR-MANDI","SHAMPO-REJOICE",1);
...
let rinso1000 = new List_items("KAMAR-MANDI","RINSO1000",7);
...
let clearMan = new List_items("KAMAR-MANDI","CLEAR-MAN",1);
// LIST ITEMS KAMAR-MANDI
let listKamarMandi = [
  ciptPasta,peptPasta,shampoLF,shampoClrBiru,panteneCond,mamaLemon,shampoHS,moltoBiru,sabunGive,sabunLFbiru,dettolOrg,liquidPink,sunlight5000,panteneBiru,sunlight2000,rejoice,sabunColek2000,downyHitam,procline500,fnl_wash,rinso1000,shinzui,sikatFormula,zincShamp,rinsoLiq,clearMan
  ]
...
let isoPlus = new List_items("MINUMAN","ISOPLUS",1);
...
let bintangZero = new List_items("MINUMAN","BINTANG-ZERO",1);
...
let panta = new List_items("MINUMAN","FANTA",1);
...
let tebsKaleng = new List_items("MINUMAN","TEBS-KALENG",1);
...
let FloriJeruk = new List_items("MINUMAN","FLORIDINA-JERUK",1);
...
let aqua_1L = new List_items("MINUMAN","AQUA-1L",1);
...
let cincauPand = new List_items("MINUMAN","CINCAU-PANDA",1);
...
let mieGelas = new List_items("MIE","MIE-GELAS",1);
...
let bubur3000 = new List_items("DAPUR","SUPER-BUBUR-3K",7);
let garamDap = new List_items("DAPUR","GARAM-DAPUR",7);
// LIST ITEMS DAPUR
let listDapur = [
  minyakPer,telur,beras,kecapBango,abcExtra,roycoAy,terasiAbc,terasiUleg,miki,minyak1L,gulaPthPer,mentegaSet,gulaPthSet,sasa500,korekKayu,roycoSapi,bonCabe,korekTokai,minyakSet,nutriJel,sardenKal,sasa5000,sasa3000,bubur3000,garamDap
  ]

// LIST OBJECT PERMEN
let mint = new List_items("PERMEN","MINTZ",1);
...
//LIST ITEMS PERMEN
let listPermen = [
  mint,bigBabol,golia,dinosX,relax,lazery,piramid,kopiko,yupi,hotPermen,kissMint
  ];
...
let cupCoffee = new List_items("TAMBAHAN","CUP-COFFEE",1);
// LIST OBJECT BABY
let mamyXl = new List_items("BABY","MAMY-XL",1);
...
// LIST ITEMS TAMBAHAN
let listTambahan = [
  kiwi,swallow15K,lamp15,lamp10,remi,kresekBolaKcl,plastikRokok,gapleh,powerGlue,plastikEs2000,abon,lamp20,korekKuping,bateraiJam,bateraiRemot,kresekBolaBesar,cupCoffee
 ]
