...
let magnumBlk12 = new List_items("ROKOK","MAGNUM-BLACK12-ORI",1);
...
let camel = new List_items("ROKOK","CAMEL12",7);
...
let jazyKretek = new List_items("ROKOK","JAZY-KRETEK",1);
...
let oskadonBiru = new List_items("OBAT","OSKADON-BIRU",1);
...
let bodrexEx = new List_items("OBAT","BODREX-EXTRA",1);
...
let pilusRumputLaut = new List_items("SNACK","PILUS-RUMPUT-LAUT",7);
...
let susuPutih = new List_items("PERKOPIAN","SUSU-PUTIH-SACHET",1);
